          ...
          <div className="register-detail-block">
            ...
            <div className="register-detail-input">
              <div className="register-detail-input-wrapper">
                <input className="register-detail-input-inputbox" placeholder="이름을 입력하세요" />
              </div>
            </div>
          </div>
          <div className="register-detail-block">
            ...
            <div className="register-detail-input">
              <div className="register-detail-input-wrapper">
                <input className="register-detail-input-inputbox" placeholder="이메일을 입력하세요" />
              </div>
            </div>
          </div>
          <div className="register-detail-block">
            ...
            <div className="register-detail-input">
              <div className="register-detail-input-wrapper">
                <input className="register-detail-input-inputbox" placeholder="아이디를 입력하세요" />
              </div>
            </div>
          </div>
          <div className="register-detail-block">
            ...
            <div className="register-detail-input">
              <div className="register-detail-input-wrapper">
                <input className="register-detail-input-inputbox" placeholder="비밀번호를 입력하세요" />
              </div>
            </div>
          </div>
        </div>
